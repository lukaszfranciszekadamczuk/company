...
public class EmployeeRepositoryImplTest {
    ...
    public void setUp() throws EmployeeNotFoundException, EmployeeAlreadyExistsException {
        repository.create(new Employee(1L, "Jan", "Kowalski", 12345678910L));
        repository.create(new Employee(2L, "Marek", "Nowak", 10987654321L));
    }
...
//
    ...
    public void should_find_employee() throws EmployeeNotFoundException, EmployeeAlreadyExistsException {
        ...
        //when
        Identifiable saved = repository.find(pesel);

        //then
        assertEquals(pesel, saved.getPesel());
    }
//
//    @Test(expected = EmployeeNotFoundException.class)
