...
public class EmployeeRepositoryImpl extends AbstractRepository implements EmployeeRepository {
    ...
    @Override
    public Identifiable create(Employee identifiable) {
        return null;
    }

    @Override
    public Employee update(Identifiable model) {
        return null;
    }

    @Override
    public void validate(Long pesel) {
        if (isNull(pesel)) {
    ...
    @Override
    public void validate(Identifiable2 model) {
...
//
//    @Override
//    public Employee find(Long pesel) throws EmployeeNotFoundException {
//        validate(pesel);
//
...
//
//    @Override
//    public Employee create(Employee model) throws EmployeeAlreadyExistsException, EmployeeNotFoundException {
//        validate(model);
